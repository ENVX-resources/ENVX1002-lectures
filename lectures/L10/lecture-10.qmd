...
It depends on which assumption is not met and the type of data i.e. circumstances.
...
How good is the model? What can we understand about the relationship between **child** and **parent**?
...
Galton collected data on the average height of both parents and their children. There was a moderate, positive, linear relationship ($r$ = 0.46) between parent and child height.
...
. . . 
  ...
  - e.g. if average parent height is 60 inches (152 cm), how tall will the child be?
  
  &nbsp;&nbsp;&nbsp;&nbsp; $23.94153 + 0.64629 \cdot 60 = 62.7$ inches (159 cm).
  
. . . 
  
  - e.g. if average parent  height is 75 inches (191 cm), how tall will the child be?
  
  &nbsp;&nbsp;&nbsp;&nbsp; $23.94153 + 0.64629 \cdot 75 = 72.4$ inches (184 cm).
...
[Download data ⬇](https://canvas.sydney.edu.au/courses/46921/pages/week-10-lectures-linear-functions?module_item_id=1752336){style="color: #1c1c84;"}

![](images/alligator.jpg){width=30%}

Photo by [Shelly Collins](https://unsplash.com/@eyedealstuff?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText){style="color: #1c1c84;"}
...
In our example, y was transformed, so we would say: 

"for every 1 cm increase in `Length`, `Weight` increases by *approximately* 3.54% (exactly 3.60%)."
