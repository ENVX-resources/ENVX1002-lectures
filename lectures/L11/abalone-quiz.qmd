...
This dataset records abalone from the coast of Tasmania, Australia (Nash, 1995) and was accessed from the [UCI Machine Learning Repository](https://archive.ics.uci.edu/dataset/1/abalone){style="color: #1c1c84;"}.
