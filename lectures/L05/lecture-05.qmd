...
We want you to do well on assessments. Contact the Learning Hub, you tutor, or Unit Coordinator to get support.
...
![Image of stream - Brightside near Braidwood](images/stream2.jpg)
...
A test statistic measureshow far the observedresult is from what we would expect under the null hypothesis.
...
## Class example: One sample t-test

We are going to do this exercise in class but I have provided an example below so you have it in the slides as well.
...
We begin by looking at the data (EDA). Ours sample size is 30 so we can look at the histogram, Q-Q plot and jitter plot.
...
Let's look at our water quality example:
