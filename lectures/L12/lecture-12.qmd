...
> Gauss-Newton approach to non-linear regression is most commonly used
...
![](images/gauss-newton-clipped.gif)
...
:::{.fragment}
### Self-starting functions have entered the chat
...
The equation is *different*. It is a logistic growth curve and assumes the lowest possible value is 0 (`c = 0` in previous equation).
