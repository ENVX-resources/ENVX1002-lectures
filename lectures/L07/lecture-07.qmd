...
$$H_0: \text{the median difference between the paired samples is equal to zero}$$
$$H_1: \text{the median difference between the paired samples is greater than zero}$$ 

What we really mean is:
$$H_0: \text{the distribution of the difference between the paired samples is centered at zero}$$
$$H_1: \text{the distribution of the difference between the paired samples is centered at a value greater than zero}$$ 
. . .

We can also say: 

- $H_0$: The distribution of the difference in median weight gain before and after the diet is centred at zero.
- $H_1$: The distribution of the difference in median weight gain before and after the diet is centred at greater than zero.
